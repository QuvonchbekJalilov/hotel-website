                ...
                <div class="slider stick-dots">
                    <div class="slide">
                        <div class="slide__img">
                            <img src="./assets/media/background/banner-bg-2.png" alt=""
                                class="full-image animated d-sm-block d-none" data-animation-in="zoomInImage">
                            <img src="./assets/media/background/mobile-banner-2.png" alt=""
                                class="full-image animated d-sm-none d-block" data-animation-in="zoomInImage">
                        </div>
                        <div class="slide__content">
                            <div class="slide__content--headings">
                                <h1 class="h-111 light-black mb-1" data-animation-in="fadeInUp">Luxury Suite
                                </h1>
                    ...
                    <div class="slide">
                        <div class="slide__img">
                            <img src="./assets/media/background/banner-bg.png" alt=""
                                class="full-image animated d-sm-block d-none" data-animation-in="zoomInImage">
                            <img src="./assets/media/background/mobile-banner.png" alt=""
                                class="full-image animated d-sm-none d-block" data-animation-in="zoomInImage">
                        </div>
                        <div class="slide__content slide__content__right">
                            <div class="slide__content--headings">
                                ...
                                <h4 class="h-56 light-black" data-animation-in="fadeInUp" data-delay-in="0.2">
                                    Discounted Prices</h4>
                            </div>
                        </div>
                    </div>
                    <div class="slide">
                        <div class="slide__img">
                            <img src="./assets/media/background/banner-bg-3.png" alt=""
                                class="full-image animated d-sm-block d-none" data-animation-in="zoomInImage">
                            <img src="./assets/media/background/mobile-banner-3.png" alt=""
                                class="full-image animated d-sm-none d-block" data-animation-in="zoomInImage">
                        </div>
                        ...
                        <div class="cards">
                            <a href="room-detail.html" class="card-item">
                                ...
                                <div class="text-block">
                                    ...
                                    <p class="sample-text mb-32">At quis nullam duis sed aliquet faucibus. Sed diam
                                        pretium cum eget.</p>
                            ...
                            <a href="room-detail.html" class="card-item">
                                <div class="card-image mb-24">
                                    ...
                                    <img src="./assets/media/card-image/image-3.png" class="card-image"
                                        alt="">
                                    <img src="./assets/media/icon/arrow-dark.png" class="icon" alt="">
                                    <img src="./assets/media/vector-shape/bottom-shape.png" class="corner-shape"
                                        alt="">
                            ...
                            <a href="room-detail.html" class="card-item">
                                <div class="card-image mb-24">
                                    ...
                                    <img src="./assets/media/card-image/image-4.png" class="card-image"
                                        alt="">
                                    <img src="./assets/media/icon/arrow-dark.png" class="icon" alt="">
                                    <img src="./assets/media/vector-shape/bottom-shape.png" class="corner-shape"
                                        alt="">
